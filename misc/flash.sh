...
esptool.py --port /dev/ttyUSB0               erase_flash || exit
esptool.py --port /dev/ttyUSB0 --baud 460800 write_flash --flash_size=detect 0 esp8266-20210902-v1.17.bin 

screen -L -Logfile flash.log -d -m -S esp8266 /dev/ttyUSB0 115200  
sleep 5
...
screen -S esp8266 -X stuff "wlan.config(dhcp_hostname='$2') ^M"
screen -S esp8266 -X stuff "wlan.connect('$3', '$4') ^M"
sleep 10
